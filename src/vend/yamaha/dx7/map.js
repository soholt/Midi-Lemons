export default { // from DX7E1.pdf
  ...
  ini: {
    cc:{
      1: { ctl:'cc', name: 0x01, min: 0, max: 127, def: 0, t: 'Modulation wheel', txt: '', type: 'range' },
      2: { ctl:'cc', name: 0x02, min: 0, max: 127, def: 0, t: 'Breath controller', txt: '', type: 'range' },
      4: { ctl:'cc', name: 0x04, min: 0, max: 127, def: 0, t: 'Foot controller', txt: '', type: 'range' },
      5: { ctl:'cc', name: 0x05, min: 0, max: 127, def: 0, t: 'Portamento time', txt: '', type: 'range' },
      6: { ctl:'cc', name: 0x06, min: 0, max: 127, def: 0, t: 'Data entry knob', txt: '(MASTER TUNE only)', type: 'range' },
      //7: Vol - main mixer
      64: { ctl:'cc', name: 0x40, min: 0, max: 127, def: 0, t: 'Sustain foot switch', txt: '', type: 'checkbox' },
      65: { ctl:'cc', name: 0x41, min: 0, max: 127, def: 0, t: 'Portamento foot switch', txt: '', type: 'checkbox' },
      96: { ctl:'cc', name: 0x60, min: 127, max: 127, def: 127, t: 'Data entry +1', txt: '', type: 'button' },
      97: { ctl:'cc', name: 0x61, min: 127, max: 127, def: 127, t: 'Data entry -1', txt: '', type: 'button' },
      125: { ctl:'cc', name: 0x7d, min: 0, max: 0, def: 0, t: 'OMNI all keys off', txt: '', type: 'button' },
      126: { ctl:'cc', name: 0x7e, min: 1, max: 1, def: 1, t: 'MONO all keys off', txt: '', type: 'button' },
      127: { ctl:'cc', name: 0x7f, min: 0, max: 0, def: 0, t: 'POLY all keys off', txt: '', type: 'button' },
    },
    params: { //g=2
      /* 
      ...
      //is in the mix Volume: {ctl:'cc', key: 0x07, min: 0, max: 127, def: 100, name: 'Volume', txt: '', type: 'range' }, //Volume#':100		# 0 .. 127,
  ...
  vox: { // g=0 defaults from DX7IIE.pdf, Page 94
    op: [ //{ // Operator
      //0: 
      { def: 99, min: 0, max: 99, t: 'EG RATE 1', type: 'range' },
      //1: 
      { def: 99, min: 0, max: 99, t: 'EG RATE 2', type: 'range' },
      //2: 
      { def: 99, min: 0, max: 99, t: 'EG RATE 3', type: 'range' },
      //3: 
      { def: 99, min: 0, max: 99, t: 'EG RATE 4', type: 'range' },
      //4: 
      { def: 99, min: 0, max: 99, t: 'EG LEVEL 1', type: 'range' },
      //5: 
      { def: 99, min: 0, max: 99, t: 'EG LEVEL 2', type: 'range' },
      //6: 
      { def: 99, min: 0, max: 99, t: 'EG LEVEL 3', type: 'range' },
      //7: 
      { def: 0, min: 0, max: 99, t: 'EG LEVEL 4', type: 'range' },
      //8: 
      { def: 39, min: 0, max: 99, t: 'KBD LVL SCALE BREAK POINT', type: 'range' }, //check max
      //9: 
      { def: 0, min: 0, max: 99, t: 'KBD LVL LEFT DEPTH', type: 'range' }, //check max
      //10:
      { def: 0, min: 0, max: 99, t: 'KBD LVL RIGHT DEPTH', type: 'range' }, //check max
      //11:
      { def: 0, min: 0, max: 3, t: 'KBD LVL LEFT CURVE', type: 'range' }, // --
      //12:
      { def: 0, min: 0, max: 3, t: 'KBD LVL RIGHT CURVE', type: 'range' },
      //13:
      { def: 0, min: 0, max: 7, t: 'KBD RATE SCALING', type: 'range' },
      //14:
      { def: 0, min: 0, max: 3, t: 'MOD SENSITIVITY AMPL', type: 'range' },
      //15:
      { def: 0, min: 0, max: 7, t: 'OP KEY VEL SENSITIVITY', type: 'range' },
      //16:
      { def: 0, min: 0, max: 99, t: 'OP OUTPUT LEVEL', type: 'range' },
      //17:
      { def: 0, min: 0, max: 1, t: 'OSC MODE', type: 'checkbox' }, // --
      //18:
      { def: 1, min: 0, max: 31, t: 'OSC FREQ COARSE', type: 'range' },
      //19:
      { def: 0, min: 0, max: 99, t: 'OSC FREQ FINE', type: 'range' },
      //20:
      { def: 7, min: 0, max: 14, t: 'OSC DETUNE', type: 'range' }
    ],//},
    props: [ //{

      //0: 
      { def: 99, min: 0, max: 99, t: 'PITCH EG RATE 1', type: 'range' },
      //1: 
      { def: 99, min: 0, max: 99, t: 'PITCH EG RATE 2', type: 'range' },
      //2: 
      { def: 99, min: 0, max: 99, t: 'PITCH EG RATE 3', type: 'range' },
      //3: 
      { def: 99, min: 0, max: 99, t: 'PITCH EG RATE 4', type: 'range' },
      //4: 
      { def: 50, min: 0, max: 99, t: 'PITCH EG LEVEL 1', type: 'range' },
      //5: 
      { def: 50, min: 0, max: 99, t: 'PITCH EG LEVEL 2', type: 'range' },
      //6: 
      { def: 50, min: 0, max: 99, t: 'PITCH EG LEVEL 3', type: 'range' },
      //7: 
      { def: 50, min: 0, max: 99, t: 'PITCH EG LEVEL 4', type: 'range' },
      //8: 
      { def: 0, min: 0, max: 31, t: 'ALGORITHM', type: 'range' },
      //9: 
      { def: 0, min: 0, max: 7, t: 'FEEDBACK', type: 'range' },
      //10:
      { def: 1, min: 0, max: 1, t: 'OSCILLATOR SYNC', type: 'checkbox' },
      //11:
      { def: 35, min: 0, max: 99, t: 'LFO SPEED', type: 'range' },
      //12:
      { def: 0, min: 0, max: 99, t: 'DELAY', type: 'range' },
      //13:
      { def: 0, min: 0, max: 99, t: 'PITCH MOD DEPTH', type: 'range' },
      //14:
      { def: 0, min: 0, max: 99, t: 'AMP MOD DEPTH', type: 'range' },
      //15:
      { def: 1, min: 0, max: 1, t: 'LFO SYNC', type: 'checkbox' },
      //16:
      { def: 0, min: 0, max: 5, t: 'WAVEFORM', type: 'range' },
      //17:
      { def: 3, min: 0, max: 7, t: 'PITCH MOD SENSITIVITY', type: 'range' },
      //18:
      { def: 24, min: 0, max: 48, t: 'TRANSPOSE', type: 'range' },
    ],//},

/*
      // same as above diff index @TODO remove one
      //126: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG RATE 1', type: 'range' },
      //127: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG RATE 2', type: 'range' },
      //128: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG RATE 3', type: 'range' },
      //129: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG RATE 4', type: 'range' },
      //130: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG LEVEL 1', type: 'range' },
      //131: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG LEVEL 2', type: 'range' },
      //132: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG LEVEL 3', type: 'range' },
      //133: 
      { def: 0, min: 0, max: 99, t: 'PITCH EG LEVEL 4', type: 'range' },
      //134: 
      { def: 0, min: 0, max: 31, t: 'ALGORITHM', type: 'range' },
      //135: 
      { def: 0, min: 0, max: 7, t: 'FEEDBACK', type: 'range' },
      //136: 
      { def: 0, min: 0, max: 1, t: 'OSCILLATOR SYNC', type: 'checkbox' },
      //137: 
      { def: 0, min: 0, max: 99, t: 'LFO SPEED', type: 'range' },
      //138: 
      { def: 0, min: 0, max: 99, t: 'DELAY', type: 'range' },
      //139: 
      { def: 0, min: 0, max: 99, t: 'PITCH MOD DEPTH', type: 'range' },
      ...
      { def: 0, min: 0, max: 99, t: 'AMP MOD DEPTH', type: 'range' },
      //141: 
      { def: 0, min: 0, max: 1, t: 'LFO SYNC', type: 'checkbox' },
      //142: 
      { def: 0, min: 0, max: 5, t: 'WAVEFORM', type: 'range' },
      //143: 
      { def: 0, min: 0, max: 7, t: 'PITCH MOD SENSITIVITY', type: 'range' },
      //144: 
      { def: 24, min: 0, max: 48, t: 'TRANSPOSE', type: 'range' },
      */
     /*
